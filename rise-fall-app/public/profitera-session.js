(() => {
  const injectMobileChrome = () => { if (document.getElementById('profitera-mobile-nav')) return; const style = document.createElement('style'); style.textContent = '@media(max-width:800px){footer{display:none!important}body{padding-bottom:82px!important}.profitera-mobile-nav{position:fixed!important;z-index:2147483647!important;left:0;right:0;bottom:0;height:72px;background:#fff;border-top:1px solid #e5e7eb;display:flex;align-items:center;justify-content:space-around;box-shadow:0 -5px 20px rgba(15,23,42,.12);font-family:Arial,sans-serif}.profitera-mobile-nav a{display:flex;min-width:52px;flex-direction:column;gap:4px;align-items:center;color:#4b5563;text-decoration:none;font-size:22px;line-height:1}.profitera-mobile-nav a:first-child{color:#f72d5d}.profitera-mobile-nav small{font-size:11px;font-weight:700}.profitera-result{position:fixed;z-index:2147483647;top:18px;right:16px;left:16px;padding:15px 18px;border-radius:12px;color:#fff;font:700 15px Arial;box-shadow:0 12px 30px rgba(0,0,0,.22)}.profitera-result.win{background:#099b5b}.profitera-result.loss{background:#dc304e}}@media(min-width:801px){.profitera-desktop-sidebar{position:fixed;z-index:2147483647;left:0;top:0;bottom:0;width:220px;padding:25px 14px;background:#111a2d;color:#fff;box-shadow:3px 0 20px #0004}.profitera-desktop-sidebar a{display:block;padding:13px 12px;color:#e7ebf5;text-decoration:none;font:600 14px Arial;border-radius:8px}.profitera-desktop-sidebar .brand{font-size:23px;font-weight:800;margin:0 0 20px}.profitera-desktop-sidebar .brand span{color:#f72d5d}.profitera-desktop-sidebar button{float:right;border:0;background:#25324b;color:white;border-radius:6px;font-size:21px}}'; document.head.appendChild(style); const nav = document.createElement('nav'); nav.id = 'profitera-mobile-nav'; nav.className = 'profitera-mobile-nav'; nav.innerHTML = '<a href="/"><span>⌂</span><small>Home</small></a><a href="/trade/"><span>⌁</span><small>Trade</small></a><a href="/automatic-trade/"><span>♙</span><small>Bots</small></a><a href="/dashboard/"><span>▧</span><small>Dashboard</small></a><a href="/account/"><span>•••</span><small>More</small></a>'; document.body.appendChild(nav); const desktop = document.createElement('aside'); desktop.className='profitera-desktop-sidebar'; desktop.innerHTML='<button>‹</button><a class="brand" href="/">Profit<span>era</span></a><a href="/dashboard/">▧ Dashboard</a><a href="/trade/">⌁ Trade</a><a href="/automatic-trade/">♙ Bots</a><a href="/portfolio/view/">▤ Reports</a><a href="/account/">⚙ Settings</a><a href="/auth/deriv/logout/">⇥ Logout</a>'; document.body.appendChild(desktop); desktop.querySelector('button').onclick=()=>desktop.classList.toggle('hidden'); };
  ...
  const mountChrome = () => { document.body.appendChild(home); injectMobileChrome(); }; if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', mountChrome, { once: true }); else mountChrome();
