(function () {
    ...
    class MarketStream {
        ...
        syncActiveSymbolUi() {
            ...
            const marketFamily = document.getElementById("market-family");
            if (marketFamily) marketFamily.textContent = market ? (market.market_display_name || market.market || "Deriv") : "Deriv";
